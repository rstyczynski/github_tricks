...
| Sprint 19 | implemented | GH-26.1. Summarize: Trigger workflow via REST API | tested |
| Sprint 19 | implemented | GH-26.2. Summarize: Correlate workflow runs via REST API | tested |
| Sprint 19 | implemented | GH-26.3. Summarize: Retrieve workflow logs via REST API | tested |
...
| Sprint 22 | under_analysis | GH-30. Prepare two slides with analysis is GitHub workflow may be used as backend to CLI running Ansible processes | analysed |
