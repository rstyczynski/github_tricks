...
**Process and Rules**:
- `rules/generic/GENERAL_RULES.md` (Sprint lifecycle, design approval)
- `rules/github_actions/GitHub_DEV_RULES.md` (GitHub implementation guidelines)
- `rules/generic/PRODUCT_OWNER_GUIDE.md` (Elaboration phase procedures)
