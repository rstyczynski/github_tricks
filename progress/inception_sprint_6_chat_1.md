...
Reviewed applicable cooperation rules (`rules/GENERAL_RULES_v1.md`, `rules/GIT_RULES_v1.md`, `rules/GitHub_DEV_RULES_v3.md`, `rules/PRODUCT_OWNER_GUIDE_v3.md`) and confirmed no ambiguities.
