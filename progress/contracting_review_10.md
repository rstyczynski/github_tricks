...
### General Rules (rules/GENERAL_RULES_v3.md)
...
### GitHub Development Rules (rules/GitHub_DEV_RULES_v4.md)
...
### Git Rules (rules/GIT_RULES_v1.md)
...
- General cooperation rules (GENERAL_RULES_v3.md)
- GitHub development rules (GitHub_DEV_RULES_v4.md)
- Git repository rules (GIT_RULES_v1.md)
