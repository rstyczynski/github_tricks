...
From `rules/generic/GENERAL_RULES.md`:
...
From `rules/generic/GIT_RULES.md`:
...
From `rules/github_actions/GitHub_DEV_RULES.md`:
...
From `rules/generic/PRODUCT_OWNER_GUIDE.md`:
